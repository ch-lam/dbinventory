    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">MSSQL Logins without permission Information</li>
        </ol>
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
				...
				$sql="SELECT instance_name,loginname,type_desc,is_disabled,db_perms,srv_perms,modify_date,scandate from mssql_loginwoperm where loginname <> 'NT SERVICE/ClusSvc' order by instance_name, loginname";
