...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <button class="btn btn-link btn-sm text-white order-1 order-sm-0" id="sidebarToggle" href="#">
      ...
      <!-- Navbar -->
    <form class="text-white d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0 ">
	  	<a href="OracleGenerateTNS.php">Generate tnsnames.ora</a>
		<br>
		<a href="OracleGenerateXMLSQLDev.php">Generate JSON SQL Developer</a>
    </form>
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Oracle JDBC TNS</li>
        </ol>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
		    ...
		    <th>Tnsnames</th>
                ...
                <tbody>
				<?php
                                $sql="select distinct upper(service_name), 'FireFlow GRP',
