    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">MSSQL Databases</li>
        </ol>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
		    ...
		    <th>AG Name</th>
				...
				$sql="SELECT hostname,env,database_name,database_state,recovery_model,compatibility_level,collation,last_backup_date,last_backup_diff_date,last_backup_log_date,is_mirroring_enabled,owner,agtype,agname FROM mssql_database order by hostname,database_id";
