    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Oracle Security Dashboard</li>
        </ol>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Security Scoring Per Databases</div>
              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                  <tr>
					  ...
					  <th>DB Name</th>
					  <th>Environment</th>
					  <th>Audit Enable (Infra)</th>
					  <th>Security Parameter (Infra)</th>
					  <th>Profile Security (Infra)</th>
					  <th>Admin High Privs (Infra)</th>
					  <th>Users With Default PWD (Infra)</th>
					  <th>Default Profile Used (Infra)</th>
                                          <th>Encrypted DB (Infra)</th>
                                          <th>Network Encryption (Infra)</th>
					  <th>High Role Privs</th>
					  <th>High Sys Privs</th>
					  <th>High Tab Privs</th>
                  </tr>
                </thead>
                <tfoot>
                  <tr>			  
				...
				$sql="SELECT compliance_score_total,
date_value,
concat('<a href=\"OracleSecurityComplianceDetails.php?db_name=',db_name,'\">Details</a>'),
db_name,
environment,
replace(replace(audit_enable_score,'1','<font color=\"green\">OK</font>'),0,'<font color=\"red\">NOK</font>'),
replace(replace(security_parameter_score,'1','<font color=\"green\">OK</font>'),0,'<font color=\"red\">NOK</font>'),
replace(replace(security_profile_score,'1','<font color=\"green\">OK</font>'),0,'<font color=\"red\">NOK</font>'),
replace(replace(admin_high_privs_score,'1','<font color=\"green\">OK</font>'),0,'<font color=\"red\">NOK</font>'),
replace(replace(default_user_pwd_score,'1','<font color=\"green\">OK</font>'),0,'<font color=\"red\">NOK</font>'),
replace(replace(default_profile_score,'1','<font color=\"green\">OK</font>'),0,'<font color=\"red\">NOK</font>'),
replace(replace(encrypted_tablespace_score,'1','<font color=\"green\">OK</font>'),0,'<font color=\"red\">NOK</font>'),
replace(replace(network_encryption_score,'1','<font color=\"green\">OK</font>'),0,'<font color=\"red\">NOK</font>'),
replace(replace(high_role_privs_score,'1','<font color=\"green\">OK</font>'),0,'<font color=\"red\">NOK</font>'),
replace(replace(high_sys_privs_score,'1','<font color=\"green\">OK</font>'),0,'<font color=\"red\">NOK</font>'),
replace(replace(high_tab_privs_score,'1','<font color=\"green\">OK</font>'),0,'<font color=\"red\">NOK</font>')
